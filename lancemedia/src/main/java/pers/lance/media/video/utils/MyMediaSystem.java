package pers.lance.media.video.utils;
 ...
 * 实现系统的播放引擎
 */
public class MyMediaSystem extends JZMediaInterface implements MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnSeekCompleteListener, MediaPlayer.OnErrorListener, MediaPlayer.OnInfoListener, MediaPlayer.OnVideoSizeChangedListener {
    ...
    public void prepare() {
        ...
        mMediaHandler.post(() -> {
            try {
                ...
                Method method = clazz.getDeclaredMethod("setDataSource", Context.class, Uri.class, Map.class);
                method.invoke(mediaPlayer, jzvd.getApplicationContext(), Uri.parse(jzvd.jzDataSource.getCurrentUrl().toString()), jzvd.jzDataSource.headerMap);
